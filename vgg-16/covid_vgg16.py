...
Original file is located at
    https://colab.research.google.com/drive/1_LujZOWo4hTxS2WNc9xLmWzA3v0oiwo2
...
VGG 16 is trained on a large dataset like Imagenet. This is a huge dataset of a multi-tude of different images in diversified categories. It is a 16-layer (convolution and fully connected) network. 
